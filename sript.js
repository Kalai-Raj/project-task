...
function populateTasks() {
    ...
    tasks.push(createTask('TASK 1', 'Design the wireframe', 'Tarek', '23/4/2023', 'in-progress'));
    tasks.push(createTask('TASK 2', 'Implement task form', 'Alexis', '25/4/2023', 'to-do'));
    tasks.push(createTask('TASK 3', 'Implement task layout', 'Kalai', '23/4/2023', 'in-progress'));
    tasks.push(createTask('TASK 4', 'Style the page', 'Tarek', '17/4/2023', 'done'));
    tasks.push(createTask('TASK 5', 'Requirement gathering', 'Alexis', '20/4/2023', 'done'));
    tasks.push(createTask('TASK 6', 'Make the page responsive', 'Kalai', '27/4/2023', 'review'));
